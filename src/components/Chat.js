...
import { Avatar, Icon, IconButton, MenuItem,Menu, collapseClasses, CircularProgress } from "@mui/material";
    ...
    <div className="chat">
      ...
      <div className="chat__header">
        ...
        <div className="chat__header--right">
          ...
          />
          <IconButton>
            <label style={{ cursor: "pointer", hieght: 24 }} htmlFor="image">
              <AddPhotoAlternate />
            </label>
          </IconButton>
      ...
      <ChatFooter input={input} onChange={event => setInput(event.target.value)}
      image={image}
      user={user}
      room={room}
      roomId={roomId}
